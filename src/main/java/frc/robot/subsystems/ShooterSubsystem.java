...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        ...
        setPID(m_lowMotorPidController, ShooterConstants.kPl0, ShooterConstants.kIl0,
        ShooterConstants.kDl0, 0);
        setPID(m_topMotorPidController, ShooterConstants.kPt0, ShooterConstants.kIt0,
        ShooterConstants.kDt0, 0);
